...
ActiveRecord::Schema.define(version: 20160425120166) do
  ...
  create_table "spree_adyen_hpp_sources", force: :cascade do |t|
  ...
  add_index "spree_adyen_hpp_sources", ["merchant_reference"], name: "index_spree_adyen_hpp_sources_on_merchant_reference", using: :btree
  add_index "spree_adyen_hpp_sources", ["psp_reference"], name: "index_spree_adyen_hpp_sources_on_psp_reference", unique: true, using: :btree
